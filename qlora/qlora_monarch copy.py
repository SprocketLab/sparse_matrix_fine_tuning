...
def train():
    ...
    if args.do_tune:
        ...
        os.environ["WANDB_RUN_GROUP"] = get_run_group("train", False, args.group, notes=args.notes)
        wandb.init(project=os.environ["WANDB_PROJECT"], group=os.environ["WANDB_RUN_GROUP"], config=vars(args),)
    ...
    if args.do_tune:
        training_args.output_dir = os.path.join(args.output_dir, os.environ["WANDB_RUN_GROUP"])
        ...
        best_run = trainer.hyperparameter_search(
            ...
            max_failures=99999, # tolerate OOM

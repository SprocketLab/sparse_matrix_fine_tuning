...
from transformers import AutoConfig, RobertaTokenizerFast, Trainer, TrainingArguments
...
roberta_model = RobertaForSequenceClassification.from_pretrained(model_id, config=config, peft_config=peft_config).to(
    device
)

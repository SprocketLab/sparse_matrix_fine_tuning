...
os.environ["PYTHONPATH"] = (
    "/fly:/fly/pyreft:/fly/pyreft/pyreft/:/fly/pyreft/pyvene"  # Allow ray tune to copy dependencies
)
import argparse
import datetime
import json
...
def main():
    ...
    parser.add_argument(
        "-type", "--intervention_type", type=str, help="LoreftIntervention", default="LoreftIntervention"
    )

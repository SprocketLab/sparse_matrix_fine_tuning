...
CUDA_VISIBLE_DEVICES=0 python run_glue.py /fly/task_configs/cola.json &
CUDA_VISIBLE_DEVICES=1 python run_glue.py /fly/task_configs/mrpc.json &
CUDA_VISIBLE_DEVICES=2 python run_glue.py /fly/task_configs/qnli.json &
CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/rte.json  &
CUDA_VISIBLE_DEVICES=4 python run_glue.py /fly/task_configs/sst-2.json &
CUDA_VISIBLE_DEVICES=5 python run_glue.py /fly/task_configs/stsb.json &

...
CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/glue_peft_configs/cola.json --project="monarch_glue_tune"  "${FLAGS[@]}" &

python run_glue.py /fly/task_configs/glue_peft_configs/mrpc.json --project="monarch_glue_tune" --do_tune=True  "${FLAGS[@]}"
CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/glue_peft_configs/mrpc.json --project="monarch_glue_tune"  "${FLAGS[@]}" &

python run_glue.py /fly/task_configs/glue_peft_configs/qnli.json --project="monarch_glue_tune" --do_tune=True  "${FLAGS[@]}"
CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/glue_peft_configs/qnli.json --project="monarch_glue_tune"  "${FLAGS[@]}" &

# python run_glue.py /fly/task_configs/glue_peft_configs/rte.json  --project="monarch_glue_tune" --do_tune=True  "${FLAGS[@]}"
CUDA_VISIBLE_DEVICES=3 # python run_glue.py /fly/task_configs/glue_peft_configs/rte.json --project="monarch_glue_tune"  "${FLAGS[@]}" &

python run_glue.py /fly/task_configs/glue_peft_configs/sst-2.json --project="monarch_glue_tune" --do_tune=True  "${FLAGS[@]}"
CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/glue_peft_configs/sst-2.json --project="monarch_glue_tune" "${FLAGS[@]}" &

python run_glue.py /fly/task_configs/glue_peft_configs/stsb.json --project="monarch_glue_tune" --do_tune=True  "${FLAGS[@]}"
CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/glue_peft_configs/stsb.json --project="monarch_glue_tune"  "${FLAGS[@]}" &

# python run_glue.py /fly/task_configs/glue_peft_configs/qqp.json  --project="monarch_glue_tune" --do_tune=True  "${FLAGS[@]}"
#CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/glue_peft_configs/qqp.json --project="monarch_glue_tune"  "${FLAGS[@]}" &

# python run_glue.py /fly/task_configs/glue_peft_configs/mnli.json --project="monarch_glue_tune" --do_tune=True  "${FLAGS[@]}"
#CUDA_VISIBLE_DEVICES=3 python run_glue.py /fly/task_configs/glue_peft_configs/mnli.json --project="monarch_glue_tune"  "${FLAGS[@]}" &
